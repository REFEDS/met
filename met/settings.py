...
try:
    ...
    from local_settings import (
        LOGIN_URL, LOGIN_REDIRECT_URL, LOGOUT_URL, LOCAL_DS, GLOBAL_DS, SAML_DESCRIPTION, SAML_ENTITYID, SAML_CONFIG,
...
STATIC_ROOT = os.path.join(BASEDIR, 'met', 'static_root')
...
STATICFILES_DIRS = (
    ...
    os.path.join(BASEDIR, 'met', 'static'),
)
