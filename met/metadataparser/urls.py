...
urlpatterns = patterns(
    'met.metadataparser.views',
    url(r'^federation/add/$', 'federation_edit',
        name='federation_add'),
    url(r'^federation/(?P<federation_slug>[-\w]+)/entityupdate_progress/$', 'entityupdate_progress',
        name='entityupdate_progress'),
    url(r'^federation/(?P<federation_slug>[-\w]+)/federation_update_entities/$', 'federation_update_entities',
        name='federation_update_entities'),
    ...
    url(r'^entity/(?P<entity_id>.+)/edit/$', 'entity_edit',
        name='entity_edit'),
...
if comments_and_proposals:
    urlpatterns += patterns(
        'met.metadataparser.views',
        url(r'^entity/(?P<entity_id>.+)/comment/$', 'entity_comment',
            name='entity_comment'),
        url(r'^entity/(?P<entity_id>.+)/proposal/$', 'entity_proposal',
